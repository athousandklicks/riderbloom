...
export default class EditName extends Component {
  ...
  removeValue = async () => {
    try {
      ...
      console.log('User name Removed successfull');
    } catch(e) {
      // remove error
    }
    console.log('Done.')
  ...
  async updateUserName(first_name) {
    try {
  ...
  async updateName(){
    ...
    .then(response => {
        if (response.status === true){
          ...
          console.log(response.user_details.firstname);

          let fullname = response.user_details.firstname;
